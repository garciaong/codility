...
public class CyclicRotation {
	...
	public static void main(String[] args) {
		 ...
		 * is moved to the first place). The goal is to rotate array A K times; that is,
		 ...
		 * rotations were made: [3, 8, 9, 7, 6] -> [6, 3, 8, 9, 7] [6, 3, 8, 9, 7] ->
		 * [7, 6, 3, 8, 9] [7, 6, 3, 8, 9] -> [9, 7, 6, 3, 8] For another example, given
		 * 
	...
	public static int[] solution(int[] A, int K) {
        ...
        if(arraySize == 0)return A;
		//Needs handling for empty array
		for (int i = 0; i < K; i++) {
			int tmp = A[maxIndex];
